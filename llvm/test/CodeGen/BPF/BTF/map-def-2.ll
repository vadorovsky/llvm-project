...
; CHECK-BTF-NEXT:        [4] TYPEDEF '__map_type' type_id=5
; CHECK-BTF-NEXT:        [5] TYPEDEF '_map_type' type_id=6
; CHECK-BTF-NEXT:        [6] STRUCT 'map_type' size=8 vlen=1
; CHECK-BTF-NEXT:                'key' type_id=1 bits_offset=0
; CHECK-BTF-NEXT:        [7] VAR 'hash_map' type_id=4, linkage=global
